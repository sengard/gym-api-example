...
import { create, loading, error, reset } from '../../actions/quantitativevalue/create';
...
const mapStateToProps = state => {
  const {created, error, loading} = state.quantitativevalue.create;
