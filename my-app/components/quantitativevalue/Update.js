...
import { success } from '../../actions/quantitativevalue/create';
import { retrieve, update, reset } from '../../actions/quantitativevalue/update';
import { loading, error } from '../../actions/quantitativevalue/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.quantitativevalue.update.retrieveError,
  retrieveLoading: state.quantitativevalue.update.retrieveLoading,
  updateError: state.quantitativevalue.update.updateError,
  updateLoading: state.quantitativevalue.update.updateLoading,
  created: state.quantitativevalue.create.created,
  deleted: state.quantitativevalue.del.deleted,
  retrieved: state.quantitativevalue.update.retrieved,
  updated: state.quantitativevalue.update.updated,
});
