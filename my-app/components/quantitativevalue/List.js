...
import { list, reset } from '../../actions/quantitativevalue/list';
import { success } from '../../actions/quantitativevalue/delete';
...
class ListComponent extends Component {
  ...
  static show(id) {
    Actions.quantitativevalueShow({id});
  }
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>unitCode: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['unitCode']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.quantitativevalue.list;
