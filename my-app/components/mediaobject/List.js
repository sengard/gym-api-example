...
import { list, reset } from '../../actions/mediaobject/list';
import { success } from '../../actions/mediaobject/delete';
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>contentUrl: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['contentUrl']}</Text>
                </View>
              </View>
            }
        />
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.mediaobject.list;
