    ...
    return (
      <View>
        ...
        <FormInput containerStyle={ {flexDirection:'row'} }
                   ...
                   id={`mediaobject_${data.input.name}`}
                   multiline={true}
  ...
  render() {
    ...
    return (
      <View style={ {backgroundColor: 'white', paddingBottom: 20} }>
        <Field component={this.renderField} name="contentUrl" type="text"
          placeholder="actual bytes of the media object, for example the image file or video file" />
