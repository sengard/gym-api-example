    ...
    return (
        <View style={styles.actionStyle}>
          <SocialIcon
              ...
              type='plus-circle'
              iconColor='#3faab4'
              onPress={() => Actions.personCreate()}
          />
          <SocialIcon
              iconSize={34}
              type='edit'
              iconColor='#3faab4'
              onPress={() => Actions.personUpdate({id})}
          />
          <SocialIcon
              iconSize={34}
              type='minus-circle'
          ...
          <ScrollView>
            ...
            <Card title="Person">
              <List title="title">
                ...
                {Show.renderRow('id', item['id'])}
                {Show.renderRow('familyName', item['familyName'])}
                {Show.renderRow('givenName', item['givenName'])}
                {Show.renderRow('birthDate', item['birthDate'])}
                {Show.renderRow('gender', item['gender'])}
                {Show.renderRow('knowsLanguage', item['knowsLanguage'])}
                {Show.renderRow('nationality', item['nationality'])}
                {Show.renderRow('unitsOfMeasurement', item['unitsOfMeasurement'])}
