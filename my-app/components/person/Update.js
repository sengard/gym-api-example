...
import { success } from '../../actions/person/create';
import { retrieve, update, reset } from '../../actions/person/update';
import { loading, error } from '../../actions/person/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.person.update.retrieveError,
  retrieveLoading: state.person.update.retrieveLoading,
  updateError: state.person.update.updateError,
  updateLoading: state.person.update.updateLoading,
  created: state.person.create.created,
  deleted: state.person.del.deleted,
  retrieved: state.person.update.retrieved,
  updated: state.person.update.updated,
});
