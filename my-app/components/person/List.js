...
import { success } from '../../actions/person/delete';
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>familyName: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['familyName']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>givenName: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['givenName']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>birthDate: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['birthDate']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>gender: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['gender']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>knowsLanguage: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['knowsLanguage']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>nationality: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['nationality']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>unitsOfMeasurement: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['unitsOfMeasurement']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.person.list;
