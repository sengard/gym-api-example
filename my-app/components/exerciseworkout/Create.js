...
import { create, loading, error, reset } from '../../actions/exerciseworkout/create';
...
const mapStateToProps = state => {
  const {created, error, loading} = state.exerciseworkout.create;
