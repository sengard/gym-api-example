...
import { success } from '../../actions/exerciseworkout/create';
import { retrieve, update, reset } from '../../actions/exerciseworkout/update';
import { loading, error } from '../../actions/exerciseworkout/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.exerciseworkout.update.retrieveError,
  retrieveLoading: state.exerciseworkout.update.retrieveLoading,
  updateError: state.exerciseworkout.update.updateError,
  updateLoading: state.exerciseworkout.update.updateLoading,
  created: state.exerciseworkout.create.created,
  deleted: state.exerciseworkout.del.deleted,
  retrieved: state.exerciseworkout.update.retrieved,
  updated: state.exerciseworkout.update.updated,
});
