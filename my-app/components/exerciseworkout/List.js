...
import { list, reset } from '../../actions/exerciseworkout/list';
import { success } from '../../actions/exerciseworkout/delete';
...
class ListComponent extends Component {
  ...
  static show(id) {
    Actions.exerciseworkoutShow({id});
  }
        ...
        <ListItem
            ...
            subtitle={
              <View>
                ...
                <View style={viewList}>
                  <Text style={listRowLeft}>order: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['order']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>AfterExerciseRestPeriod: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['AfterExerciseRestPeriod']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>baseRep: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['baseRep']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>baseSet: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['baseSet']}</Text>
                </View>
                <View style={viewList}>
                  <Text style={listRowLeft}>baseTime: </Text>
                  <Text style={[listRowRight, {fontWeight: 'bold'}]}>{item['baseTime']}</Text>
                </View>
                <View style={viewList}>
...
const mapStateToProps = state => {
  const {retrieved, error, loading, eventSource} = state.exerciseworkout.list;
